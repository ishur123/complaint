<div class="max-w-screen-md mx-auto">
    <x-card>
        <form wire:submit="saveMasterData">
            <div class="space-y-6">
                <div class="flex items-center space-x-3 space-y-6">
                    <div class="w-3/4">
                        <x-select wire:model.live="selState" label="Select State"
                ...
                <div class="flex items-center space-x-3">
                    <div class="w-3/4">
                        <x-select wire:model.live="selMandal" label="Mandal"
                ...
                <div class="flex items-center space-x-3">
                    <div class="w-3/4">
                        <x-select wire:model.live="selDistt" label="Distt"
                ...
                <div class="flex items-center space-x-3">
                    <div class="w-3/4">
                        <x-select wire:model="selNatureOfComplaint" label="Nature of Complaint"
